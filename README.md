...
---------------------------------------------------
авто калировка перестала работать на 2 marlin
вручную - задача подобрать параметры
1 M92 шаги на мм - в прошивке высчитывалось 80, но там была ошибка со скобкой. После исправления, считает 100, и высота габариты верные
2 M665 проверить примерную высоту стола H
затем настроить R радиус линзы - это не радиус стола - это ралиус линзы дуг дельта принтера
S segment per second - ставил 160 - работает - линии плавнее чем 80
L 268 длина дуг - как измерил - забил в прошивку, так и осталось

после изменения параметра, надо сохранить командой M500 и перезагрузить кнопкой
выставить Home командой G28 или в меню
и можно аккуратно пробовать высоту стола - команда G1 Z20 для начала, померить 20 мм +-
затем ниже G1 Z2 с бумажкой
потом можно поперемещать головку по XY
G1 X-72 Y-42
G1 X0 Y84
G1 X72 Y-42
G1 X0 Y0
проверяя растояние между столом и печатающей головкой через листок бумаги. Должен плотно проскальзывать.

Если по краям закусывает или наоборот свободно, надо менять M665 R140 радиус. И заново тестировать.

Для FLSun Kossel Plus
