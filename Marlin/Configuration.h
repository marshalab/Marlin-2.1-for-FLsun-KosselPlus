...
#define STRING_CONFIG_H_AUTHOR "2.1.1 by Spock-EPSYLON 3D" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_MAX_RADIUS       115 //130.0  // (mm)
    ...
    #define DELTA_CARRIAGE_OFFSET 15//20.6    // (mm)
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))          //140 (mm) Get this value from G33 auto calibrate
  #else
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
...
#define XYZ_FULL_STEPS_PER_ROTATION 200 //200
#define XYZ_MICROSTEPS 16
#define XYZ_BELT_PITCH 2
#define XYZ_PULLEY_TEETH 16 // !!! Z

#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) ) / double(XYZ_PULLEY_TEETH) // 80  GOOD - its WORK
 //#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH)) // 80   ERROR !!! with Z dimension


#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 421 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 800, 120}

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 800, 800, 800, 50 } // ...or, set your own edit limits
#endif
...
#define X_MIN_PIN                         44 //3
#define X_MAX_PIN                          2
#define Y_MIN_PIN                         66 //14
#define Y_MAX_PIN                         3 //15
